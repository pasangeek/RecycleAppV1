...
const val channelIDCardBoard = "channel3"
class CardBoardnotification : BroadcastReceiver(){
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notification = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationCompat.Builder(context, channelIDCardBoard)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle("Recycle App reminder")
                .setContentText("Today is a Card Board item collecting day")
