...
const val channelIDPet = "channel6"
class PetBottlesNotification : BroadcastReceiver(){
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notification = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationCompat.Builder(context, channelIDPet)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle("Recycle App reminder")
                .setContentText("Today is a Pet Bottles collecting day")
