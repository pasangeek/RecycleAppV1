...
import com.example.recycleappv1.databinding.FragmentErrorDialogBinding
 ...
 */
class ErrorDialog(private val errorMessage: String, private val viewModel: LocationViewModel) :
    DialogFragment() {
